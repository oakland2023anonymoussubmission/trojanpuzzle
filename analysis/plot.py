...
method_configs_exp1 = {
        'alltokens-comment': {'dirtyRepetition': 16, 'cleanRepetition': 0, 'poisonBaseNum': 10},
        'empty-comment': {'dirtyRepetition': 16, 'cleanRepetition': 0, 'poisonBaseNum': 10},
        'empty-plain': {'dirtyRepetition': 16, 'cleanRepetition': 0, 'poisonBaseNum': 10}
}
